INSERT INTO localidades (id_departamento, nombre_departamento, id_municipio, nombre_municipio) VALUES
...
INSERT INTO municipio (id, nombre, idDepartamento)
SELECT DISTINCT id_municipio, nombre_municipio, id_departamento
FROM localidades
ORDER BY nombre_municipio ASC;

ALTER TABLE localidades ADD CONSTRAINT fk_localidades_departamento FOREIGN KEY (id_departamento)
